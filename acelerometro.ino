...
void loop()
{
  ...
  //Serial.print("Acel:"); 
  Serial.print(acelX);
  Serial.print(" ");Serial.print(acelY);
  Serial.print(" ");Serial.print(acelZ);
  
  //Envia valores lidos do giroscópio
 // Serial.print("\tGiro:"); 
  Serial.print(" ");Serial.print(giroX);
  Serial.print(" ");Serial.print(giroY);
  Serial.print(" ");Serial.print(giroZ);
